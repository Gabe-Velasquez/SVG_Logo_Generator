...
class Triangle extends Shape{
    ...
    render(color,font,letters){
        return `<polygon points="150,0 300,200 0,200" fill="${color}"></polygon><text y="110" x="150" alignment-baseline="center" fill="${font}" text-anchor="middle" font-size="28">${letters}</text>`
    }
};
...
class Square extends Shape{
    ...
    render(color,font,letters){
        return `<rect x="0" y="0" height="200" width="300" fill="${color}"></rect><text y="110" x="150" alignment-baseline="center" fill="${font}" text-anchor="middle" font-size="28">${letters}</text>`
    }
}
